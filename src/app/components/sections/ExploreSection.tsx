  ...
  const exploreItems: ExploreItem[] = [
    {
      id: 1,
      umkmId: '2',
      vendorName: 'AYAM GEPREK BU ROSITA',
      vendorDescription: 'Ayam geprek dengan sambal level yang beragam, mulai dari level 1 hingga level 10. Cocok untuk pecinta makanan pedas!',
      vendorImage: '/assets/images/umkm/geprek-cikini.webp',
      reviewAvatar: '/assets/images/avatar/female1.png',
      reviewRating: 4.2,
      reviewText: 'Pelayanan cepat dan makanan yang disajikan sangat lezat. Level pedasnya bisa disesuaikan. Sangat direkomendasikan!',
      productName: 'Ayam Geprek Level 5',
      productDescription: 'Nikmati sensasi pedas yang pas dengan ayam geprek renyah dan sambal spesial level 5.',
    ...
    },
    {
      id: 3,
      umkmId: '3',
      vendorName: 'WARUNG KOPI TUGU',
      vendorDescription: 'Warung kopi tradisional dengan biji kopi pilihan dan suasana yang nyaman untuk nongkrong.',
      vendorImage: '/assets/images/umkm/baram-cafe.webp',
      reviewAvatar: '/assets/images/avatar/female3.png',
      reviewRating: 4.3,
      reviewText: 'Kopi nya enak banget! Suasana nyaman dan harga terjangkau. Cocok buat nongkrong atau kerja.',
      productName: 'Kopi Susu Gula Aren',
      productDescription: 'Perpaduan sempurna espresso lokal dengan susu segar dan gula aren organik.',
      productImage: '/assets/images/umkm/ayam_geprek_77.webp'
    }
  ];
              ...
              <AnimatePresence mode="wait" custom={direction}>
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 h-full">
                    <Link href={`/umkm/${currentItem.umkmId}`}>
                      <motion.div whileHover={{ y: -8 }} transition={{ duration: 0.3 }} className="relative rounded-3xl overflow-hidden shadow-lg group cursor-pointer bg-gray-200 h-full">
                        <SafeImage 
                          ...
                          priority
                          fallback="/assets/images/umkm/produk.webp"
                        />
                    ...
                    <div className="hidden lg:flex flex-col gap-6">
                      <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.3 }} className="bg-white rounded-3xl shadow-lg p-6 md:p-8 flex items-start gap-4 border border-gray-100">
                        <div className="relative w-14 h-14 md:w-16 md:h-16 rounded-full overflow-hidden shrink-0 border-2 border-orange-200 bg-gray-200">
                          <SafeImage 
                            src={currentItem.reviewAvatar} 
                            alt="User avatar" 
                            fill 
                            className=""
                            fallback="/assets/images/avatar/female1.png"
                          />
                        </div>
                      ...
                      <motion.div whileHover={{ y: -8 }} transition={{ duration: 0.3 }} className="relative rounded-3xl overflow-hidden shadow-lg flex-1 min-h-[400px] group cursor-pointer bg-gray-200">
                        <SafeImage 
