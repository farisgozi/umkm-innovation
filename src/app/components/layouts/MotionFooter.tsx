...
export default function MotionFooter() {
  ...
  return (
    <footer ref={footerRef} className="relative overflow-hidden mt-20">
      ...
      {/*  Konten Footer */}
      <Container>
        <div className="footer-content flex flex-col items-center justify-center gap-3 py-20 text-[#2E2E2E] text-center">
          <h2 className="text-7xl font-bold tracking-wide">
            Dukung <span className="opacity-90"> Bisnis Lokal</span>
          </h2>
